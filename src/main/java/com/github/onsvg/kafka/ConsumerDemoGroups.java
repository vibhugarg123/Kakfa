...
/*
Suppose there are 3 consumers, partitions will be assigned to dedicated consumers.
Eg: Number of consumers=2, topic=first_topic partitions=3
Re-balancing happens
Consumer-1 Setting newly assigned partitions [first_topic-0, first_topic-1]
Consumer-2 Setting newly assigned partitions [first_topic-2]

If any consumer gets down or exited, others consumers will re-balance.
Eg- if 1 consumer goes down, re-balancing happens, all the partitions will be read by one consumer.
 */
